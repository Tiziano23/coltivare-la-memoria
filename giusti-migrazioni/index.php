...
<head>
    ...
    <title>Coltivare la Memoria - Giusti per le migrazioni</title>
...
<body>
    ...
    <div class="container-lg mt-4" style="margin-bottom:5rem">
        <div class="container-fluid" style="max-width:120ch;">
            <h1 class="display-2 mb-4">Giusti per le migrazioni</h1>
            <div class="mx-auto fs-5" style="text-align:justify;max-width:80ch">
                <p>
                    Fin dall'antichità, la storia umana è stata caratterizzata da flussi migratori di massa.
                    Si stima che gli sfollati, all'interno del loro Paese o all'estero, siano in totale 68,5 milioni, l'1% della popolazione mondiale.
            ...
            <div class="item-list vstack gap-5 my-4">
                <a class="item hstack gap-3 p-3 shadow" href="giusti-migrazioni/costantino-baratta">
                    <img class="image img-thumbnail" src="content/pictures/baratta/2.jpg" alt="Costantino Baratta" />
